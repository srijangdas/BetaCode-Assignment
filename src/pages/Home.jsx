  ...
  return (
    <div className="p-10 flex flex-col items-center justify-center h-screen w-full">
      ...
      <div className="p-10 flex gap-8">
        ...
        <button className="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2">
          Data-Grid
        </button>
      </div>
